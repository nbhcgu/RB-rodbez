...
class DriverRideCanceDetailsPage extends StatefulWidget
...
@override
DriverRideCanceDetailsPageState createState() => DriverRideCanceDetailsPageState();
}

class DriverRideCanceDetailsPageState extends State<DriverRideCanceDetailsPage> {
  String rideId="",sPlace="",ePlace="",date="",cab="",cab_icon="",cabData="",cabSeat="",fare="",baseFare="",taxes="",status="",
      ...
      extra_km_text="",extra_time_text="",round_off_text="",extra_km_fare="",extra_time_charge="",round_off_amount="";
  var rules=[], inc=[],msg=[];
  bool extra_km_status= false,extra_time_status=false,round_off_status=false,tax_status=false,status_message_status=false;
  _getData() async {
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          flex: 1,
                          child: SizedBox(
                            child: cab_icon.isEmpty?Icon(Icons.account_circle_rounded,color: Colors.black,size: 70,):
