...
import 'package:rodbez/Customer/add_driver.dart';
...
import 'cus_search_page.dart';
import 'menu/cus_profile_setting.dart';
import 'menu/cus_support_page.dart';
import 'menu/cus_your_ride_page.dart';
...
class CustomerHomePageState extends State<CustomerHomePage> with SingleTickerProviderStateMixin{
...
//crear Marker
  ...
  late String rider_name="",rider_contact="",rider_img="",user_type="",uId;
  late bool become_driver = false;
  getRiderSelf() async {
    ...
    setState((){
      ...
      become_driver = prefs.getBool('become_driver') ?? false;
    });
  }
  @override
  void initState() {
 ...
 Future<void> getPos() async {
  ...
  static const CameraPosition initialCameraPosition = CameraPosition(target: LatLng(25.5941, 85.1376), zoom: 15);
  @override
                    ...
                    children:[
                              ...
                              child: FittedBox(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                    Text(rider_name, style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold),),
                                    SizedBox(height: 10,),
                                      Text(rider_contact, style: TextStyle(color: Colors.white, fontSize: 14),),
                                  ],),
                                ),
                              ),
                            )
                      ...
                      SizedBox(height: 1.0,),
                       GestureDetector(
                          onTap: ()
                          {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> CustomerYourRidePage()));
                          },
                          child:  ListTile(
                            leading: Icon(Icons.history,color: Colors.black,),
                            title: Text("Your Ride", style: TextStyle(fontSize: 15.0,),),
                          ),
                        ),
                       GestureDetector(
                          onTap: ()
                       ...
                       GestureDetector(
                          ...
                          child:  ListTile(
                            leading: Icon(Icons.miscellaneous_services,color: Colors.black,),
                       ...
                       GestureDetector(
                          onTap: ()
                          async {
                          await  Navigator.push(context, MaterialPageRoute(builder: (context)=> CustomerProfileDetailsPage()));
                          getRiderSelf();
                          },
                          child:  ListTile(
                            leading: Icon(Icons.settings,color: Colors.black,),
                            title: Text("Profile Setting", style: TextStyle(fontSize: 15.0),),
                          ),
                        ),
                      become_driver? GestureDetector(
                          onTap: ()
                          async {
                          await  Navigator.push(context, MaterialPageRoute(builder: (context)=> AddDriver()));
                          getRiderSelf();
                          },
                          child:  ListTile(
                            leading: Icon(Icons.add,color: Colors.green,),
                            title: Text("Add Driver", style: TextStyle(fontSize: 15.0,color: Colors.green),),
                          ),
                        ):SizedBox(),
                      user_type=="driver"? GestureDetector(
                          onTap: ()
                          async {
                          await  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> DriverPage()),
                                  (Route<dynamic> route) => false);
                          getRiderSelf();
                          },
                          child:  ListTile(
                            leading: Icon(Icons.swap_horizontal_circle_outlined,color: Colors.green,),
                            title: Text("Driver Mode", style: TextStyle(fontSize: 15.0,color: Colors.green),),
                          ),
                        ):SizedBox(),
                    ],
                  ),
                      ...
                      Expanded(
                        ...
                        child: GestureDetector(
                          ...
                          child: ListTile(
                            ...
                            title: Text("Sign Out", style: TextStyle(fontSize: 16.0, color: Colors.black,fontWeight: FontWeight.w300,),),
                          ),
                        ),
                      ),
                    ],
                  ...
                  child: Column(
                    ...
                    children: [
                      GestureDetector(
                        onTap: ()
                        {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> CustomerSearchPage(cur_address: address,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Flexible(
                                  child: FittedBox(
                                    child: Text("Search Your Destination ", style: TextStyle(fontSize: 18.0, color: Colors.black, fontWeight:FontWeight.bold ),
                               // maxLines: 1,
