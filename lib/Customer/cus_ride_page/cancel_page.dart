      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //                 // mainAxisAlignment: MainAxisAlignment.spaceBetween,
            //                 children: [
            //                   Text("     Support ", style: TextStyle(fontSize: 14.0, color: Colors.black),),
            //                   Padding(
            //                     padding: const EdgeInsets.fromLTRB(120,0,0,0),
            //                     child: Image.asset('assets/arrow.png', alignment: Alignment.bottomRight, height: 40.0, width: 40.0,),
            //                   ),
            //                 ],
            //               ),
            //             ),
            ...
            //     ),
            //     child: Text("Collect Cash"),color: Colors.black,elevation: 5,textColor: Colors.white,
            //     onPressed: (){
